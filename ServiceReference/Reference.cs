...
namespace ServiceReference
{
    ...
    public partial class EnrollmentRequest : object
    {
        ...
        private string MesInicioPagoField;
    ...
    public partial class EnrollmentProcessRequestBody
    {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public ServiceReference.EnrollmentRequest er;
        
        public EnrollmentProcessRequestBody()
        {
        }
        
        public EnrollmentProcessRequestBody(ServiceReference.EnrollmentRequest er)
        {
            this.er = er;
        }
    }
    ...
    public partial class EnrollmentServiceClient : System.ServiceModel.ClientBase<ServiceReference.IEnrollmentService>, ServiceReference.IEnrollmentService
    {
        ...
        public System.Threading.Tasks.Task<ServiceReference.EnrollmentProcessResponse> EnrollmentProcessAsync(ServiceReference.EnrollmentRequest er)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IEnrollmentService_soap))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:5239/EnrollmentService.asmx");
            }
            throw new System.InvalidOperationException(string.Format("No se pudo encontrar un punto de conexión con el nombre \"{0}\".", endpointConfiguration));
        }
